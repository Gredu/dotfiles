...
vim.keymap.set('n', '<space>rn', ':lua vim.lsp.buf.rename()<CR>',                                     opts)
vim.keymap.set('n', 'gr',        ':lua vim.lsp.buf.references()<CR>',                                 opts)
vim.keymap.set('n', '<space>e',  ':lua vim.lsp.diagnostic.show_line_diagnostics()<CR>',               opts)
vim.keymap.set('n', 'gJ',        ':lua vim.diagnostic.goto_next()<CR>',                               opts)
vim.keymap.set('n', 'gK',        ':lua vim.diagnostic.goto_prev()<CR>',                               opts)
vim.keymap.set('n', '<space>q',  ':lua vim.lsp.diagnostic.set_loclist()<CR>',                         opts)
